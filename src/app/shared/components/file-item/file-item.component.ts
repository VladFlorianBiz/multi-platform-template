...
export class FileItemComponent implements OnInit {
  ...
  setShowMetaDataFlag(_value) {
    this.showMetaDataFlag = _value;
  }


  editFileMetaData() {
    this.setShowMetaDataFlag(true);
  }

  onKeyInputChange(event) {
    console.log('onKeyInputChange event', event)
    console.log('onKeyInputChange event?.detail', event?.detail);
    console.log('onKeyInputChange event?.target', event?.target);
    console.log('onKeyInputChange event?.value', event?.value);
  }


  onValueInputChange(event) {
    console.log('onValueInputChange event', event)
    console.log('onValueInputChange event?.detail', event?.detail);
    console.log('onValueInputChange event?.target', event?.target);
    console.log('onValueInputChange event?.value', event?.value);
  }
  ...
  deleteFile() {
    console.log('deleteFikle clicked!',)
    if (this.isLinkedMediaItem) {
